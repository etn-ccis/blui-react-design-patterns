...
describe('Form validation fix length passcode', () => {
    ...
    it('should display incorrect passcode error', () => {
        ...
        cy.get('.MuiFormHelperText-root.Mui-error').should('contain', 'Incorrect Passcode');
    });
    ...
    it('should display six-digit passcode error on blur', () => {
        ...
        cy.get('.MuiFormHelperText-root.Mui-error').should('contain', 'Please enter a six-digit passcode.');
    });

    it('should reset the form', () => {
        cy.get('#passcode-input').type('78978').blur();
        cy.get('[data-cy=reset]').click();
        cy.get('.MuiFormHelperText-root.Mui-error').should('not.exist');
    });
