...
it('should remove item', () => {
  ...
  // multiselectList.find(Checkbox).at(0).prop('checked')();

  // act(() => {
  // multiselectList.find(Checkbox).at(0).props().checked=true; 
  multiselectList.find('.checkbox').hostNodes().at(0).simulate('change',{ target: { checked: true } });
  expect((multiselectList).find('.checkbox').hostNodes().at(0))
